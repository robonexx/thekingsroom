    ...
    <div className='h-full bg-gray-200 pb-20'>
      ...
      >
        ...
        <input
          ...
          maxLength={1}
          accept='.jpg,.png,.jpeg'
          className='mt-5 w-full rounded-md border border-zinc-800 py-3 pl-3 text-black font-normal'
        />
        <BlogEditor blogData={blogData} setBlogData={setBlogData} />
        <div className='mx-auto my-8 w-full max-w-[50%] lg:max-w-[40%] '>
          <button
            type='submit'
            className='mt-20 w-full cursor-pointer rounded-md bg-gradient-to-r from-black to-[#888] py-3 font-semibold text-white transition duration-200 ease-in-out active:scale-90 md:mt-8'
          >
            Publish post
          </button>
        </div>
